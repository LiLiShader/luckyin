...
export default class HttpRequest{
    ...
    public async bet(Requestbody,betAmount:number,currency:number,gameId:number,useL:boolean) :Promise<any>{
        const apiUrl = `/pc/api/v1/slotMachine2/bet?betAmount=${betAmount}&currency=${currency}&gameId=${gameId}&useL=${useL}`; // 新增变量
        try {
